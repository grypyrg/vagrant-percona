	...
	if( File.readable?( aws_secrets_file ))
		config.vm.provider "aws" do |aws, override|
			...
			if region == nil
				...
				STDERR.puts "Warning: AWS region #{region} not defined in your ~/.aws_secrets file."
			end
		...
		STDERR.puts "Skipping AWS because of missing/non-readable #{aws_secrets_file} file. Read https://github.com/percona/xtradb-cluster-tutorial/blob/master/README_AWS.md for more information about setting up AWS."
	end
end
